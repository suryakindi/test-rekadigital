      ...
      <form action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="card-body">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="heading" name="oldheading" value="{{$about->heading}}" readonly>
              </div>
            <div class="form-group">
            <label for="editheading">Edit Heading</label>
            <input type="text" class="form-control" id="editheading" name="heading" placeholder="Heading">
          </div><hr><hr>
